...
use OAT\Library\GraderMessengerBridge\Message\Event\ScoringEvent\ReviewerRequiredScoringEvent;
use PHPUnit\Framework\TestCase;

class ReviewerRequiredScoringEventTest extends TestCase
{
    ...
    private ReviewerRequiredScoringEvent $subject;

    protected function setUp(): void
    {
        $this->subject = new ReviewerRequiredScoringEvent(
            self::TENANT_ID,
