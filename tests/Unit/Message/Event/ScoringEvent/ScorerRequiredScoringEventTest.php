...
use OAT\Library\GraderMessengerBridge\Message\Event\ScoringEvent\ScorerRequiredScoringEvent;
use PHPUnit\Framework\TestCase;

class ScorerRequiredScoringEventTest extends TestCase
{
    ...
    private ScorerRequiredScoringEvent $subject;

    protected function setUp(): void
    {
        $this->subject = new ScorerRequiredScoringEvent(
            self::TENANT_ID,
