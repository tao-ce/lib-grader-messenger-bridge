...
use OAT\Library\GraderMessengerBridge\Message\Event\ScoringEvent\ScoringStrategyFailedScoringEvent;
use PHPUnit\Framework\TestCase;

class ScoringStrategyFailedScoringEventTest extends TestCase
{
    ...
    private ScoringStrategyFailedScoringEvent $subject;

    protected function setUp(): void
    {
        $this->subject = new ScoringStrategyFailedScoringEvent(
            self::TENANT_ID,
